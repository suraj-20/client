              ...
              <div className="grid">
                <div className="grid-content">
                  ...
                  <div className="grid-contents">
                    <p className="grid-content-heading">Callback</p>
                ...
                <div className="grid-content">
                  ...
                  <div className="grid-contents">
                    <p className="grid-content-heading">Book Now</p>
                ...
                <div className="grid-content">
                  ...
                  <div className="grid-contents">
                    <p className="grid-content-heading">Fare Lock</p>
                ...
                <div className="grid-content">
                  ...
                  <div className="grid-contents">
                    <p className="grid-content-heading">Lowest Fare</p>
                ...
                <div className="grid-content">
                  ...
                  <div className="grid-contents">
                    <p className="grid-content-heading">Confidence</p>
                ...
                <div className="grid-content">
                  ...
                  <div className="grid-contents">
                    <p className="grid-content-heading">24/7 Assistance</p>
